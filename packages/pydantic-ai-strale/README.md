# pydantic-ai-strale — DEPRECATED

This package was yanked from PyPI on 2026-04-22.

For Pydantic AI integration with Strale, use the **Strale MCP server** at `https://api.strale.io/mcp`. Every Strale capability is exposed as an MCP tool, and Pydantic AI supports MCP natively.
