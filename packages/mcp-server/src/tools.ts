...
ACCESSING TRUST DATA
  ...
  // Web3 Assurance retired 2026-05-04 — code deleted in lockstep with the
  // archived product page (Notion). The MCP tool is unregistered; clients
  // that previously called strale_web3_assurance now get tool-not-found.
}
