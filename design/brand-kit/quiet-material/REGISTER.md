# Quiet Material - current consolidation register

Generated from registry.json. Status: candidate. Production is not adopted.

Current consolidation proposal; active.json alone controls production.
...
Keep image-only. No matched amber card is defined; no invented amber glass.

- File: `public/strale-site/design-system/assets/brand-library/pattern-folded-dark-amber-v1.png`
...
### QM-01: Every current atmosphere has a record (recorded)

All 14 current image tokens have exact file identity, role, pairing and provenance-confidence fields. Eleven previously unrecorded assets remain honest about unknown creation history.

Still open: Recover generator/date/rights evidence before unrestricted external exports.

### QM-02: Missing references are explicit (unavailable-recorded)

Neither references/ nor assets/capability-illustrations/ exists in the preserved extraction or current tracked sibling tree. No replacement image is invented.

Still open: Recover originals if needed; unavailable files are not build dependencies.
...
A live constellation diagram can explain labelled relationships. The generic constellation/global-field rasters remain excluded. Evidence-stack stays an unapproved editorial reference.

Still open: Missing capability illustrations are unavailable; no complete icon library is claimed.

### QM-06: Identity and functional glyphs are separate (proposed)

Keep the flowing-S lockup as the identity reference. The compass remains a legacy favicon conflict; a four-point transformation glyph has a functional role, not an identity role.

Still open: Produce S favicon/avatar/inverse exports from a verified mark master and test small sizes in the identity batch.

## Identity and illustration

- **flowing-s-lockup** (retained-reference): Retained brand identity reference.  Source: `public/strale-site/design-system/assets/strale-lockup.svg`.

- **legacy-compass** (legacy-conflict): Legacy favicon; comparison only, excluded from new identity exports.  Source: `public/favicon.svg`.

- **strale-product-support-constellation-light-v1** (reference-only): Decorative metaphor, never API evidence. Generic decorative raster rejected; a live diagram with explicit relationships is a different medium. Source: `public/strale-site/design-system/assets/brand-library/product-support-constellation-light-v1.png`.

- **strale-editorial-evidence-stack-light-v1** (reference-only): Decorative metaphor, never API evidence. Candidate editorial metaphor; requires a real editorial job and separate acceptance. Source: `public/strale-site/design-system/assets/brand-library/editorial-evidence-stack-light-v1.png`.

- **strale-editorial-global-field-dark-v1** (reference-only): Decorative metaphor, never API evidence. Generic decorative raster rejected; a live diagram with explicit relationships is a different medium. Source: `public/strale-site/design-system/assets/brand-library/editorial-global-field-dark-v1.png`.

## Unavailable sources

- `public/strale-site/design-system/references/quiet-material-direction-v1.png`: unavailable; excluded from required build inputs.

- `public/strale-site/design-system/assets/capability-illustrations/`: unavailable; excluded from required build inputs.
