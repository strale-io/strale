...
test('radius variables cannot hide off-scale corner geometry',()=>{for(const radius of ['17px','16rem','16garbage']){const x=clone(t);x.layout.css_variables['--menu-radius']=radius;assert.throws(()=>validate(r,x));}});
