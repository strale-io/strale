...
test('cannot silently change retained type or control values',()=>{for(const mutate of [t=>t.type.scale.body.size=12,t=>t.layout.css_variables['--control-radius']='4px']){const [r,t]=data();mutate(t);assert.throws(()=>validate(r,t));}});
