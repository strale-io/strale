...
|---|---|---|
| Review next — proposed narrative and illustration objectives | [Homepage narrative](../../docs/programs/brand-website/HOMEPAGE-NARRATIVE.md) | [Current disposition](../../docs/programs/brand-website/system-completion.json) |
...
| Forms, feedback, utility icons and density | [Interactive patterns](quiet-material/patterns/index.html) · [Usage and limits](quiet-material/patterns/README.md) | [Pattern registry](quiet-material/patterns/registry.json) |
| Cross-channel composition | [Website](quiet-material/patterns/website.html) · [Social](quiet-material/patterns/social.html) · [Email](quiet-material/patterns/email.html) | [Shared story and budgets](quiet-material/patterns/registry.json) |
...
| Historical homepage draft and selected-asset readiness | [Homepage brief](../../docs/programs/brand-website/HOMEPAGE-BRIEF.md) | [Editable authoring source](../../docs/programs/brand-website/homepage-brief.json) |
...
| Hero treatment B — selected for continued design | [Historical A/B comparison](quiet-material/hero-comparison/index.html) | [Current acceptance](../../docs/programs/brand-website/system-completion.json) |
| Set-aside copy and opening — historical evidence only | [Copy study](quiet-material/hero-copy/README.md) · [Two-section study](quiet-material/opening/README.md) | [Current disposition](../../docs/programs/brand-website/system-completion.json) |
