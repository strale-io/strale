...
5 subtrees, 321 files total.

| subtree | files | newest (by filename date) |
| --- | --- | --- |
| `archive/growth-ops/` | 23 | _(no dated filenames)_ |
| `archive/receipts/` | 17 | `2026-09-05-check-brand-positioning-brief.json` (2026-09-05) |
| `archive/sessions/` | 263 | `2026-09-05-quiet-material-review.md` (2026-09-05) |
