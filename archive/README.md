...
5 subtrees, 331 files total.

| subtree | files | newest (by filename date) |
| --- | --- | --- |
| `archive/growth-ops/` | 23 | _(no dated filenames)_ |
| `archive/receipts/` | 23 | `2026-09-05-check-quiet-material-document-polish.json` (2026-09-05) |
| `archive/sessions/` | 267 | `2026-09-05-quiet-material-review.md` (2026-09-05) |
