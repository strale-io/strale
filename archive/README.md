...
5 subtrees, 325 files total.

| subtree | files | newest (by filename date) |
| --- | --- | --- |
| `archive/growth-ops/` | 23 | _(no dated filenames)_ |
| `archive/receipts/` | 19 | `2026-09-05-check-quiet-material-consolidation.json` (2026-09-05) |
| `archive/sessions/` | 265 | `2026-09-05-quiet-material-review.md` (2026-09-05) |
