...
5 subtrees, 378 files total.

| subtree | files | newest (by filename date) |
| --- | --- | --- |
| `archive/growth-ops/` | 23 | _(no dated filenames)_ |
| `archive/receipts/` | 47 | `2026-09-06-check-brand-shared-access.json` (2026-09-06) |
| `archive/sessions/` | 290 | `2026-09-05-quiet-material-review.md` (2026-09-05) |
