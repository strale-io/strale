...
5 subtrees, 342 files total.

| subtree | files | newest (by filename date) |
| --- | --- | --- |
| `archive/growth-ops/` | 23 | _(no dated filenames)_ |
| `archive/receipts/` | 30 | `2026-09-05-check-quiet-material-foundations.json` (2026-09-05) |
| `archive/sessions/` | 271 | `2026-09-05-quiet-material-review.md` (2026-09-05) |
