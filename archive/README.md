...
5 subtrees, 350 files total.

| subtree | files | newest (by filename date) |
| --- | --- | --- |
| `archive/growth-ops/` | 23 | _(no dated filenames)_ |
| `archive/receipts/` | 34 | `2026-09-05-check-quiet-material-patterns.json` (2026-09-05) |
| `archive/sessions/` | 275 | `2026-09-05-quiet-material-review.md` (2026-09-05) |
