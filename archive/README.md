...
5 subtrees, 315 files total.

| subtree | files | newest (by filename date) |
| --- | --- | --- |
| `archive/growth-ops/` | 23 | _(no dated filenames)_ |
| `archive/receipts/` | 18 | `2026-09-05-check-brand-positioning-brief.json` (2026-09-05) |
| `archive/sessions/` | 256 | `2026-09-05-quiet-material-review.md` (2026-09-05) |
