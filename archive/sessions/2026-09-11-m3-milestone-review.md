...
| 5 | Old entrypoints remain in force | MET | No M3 commit touched `CLAUDE.md`, `AGENTS.md`, `.claude/` or `.agents/` (`git log --name-only 1f4203e2..9b668922` on those paths is empty apart from the unrelated DEC-20260910-A waiver entry in PR #628). Nothing was activated. |
