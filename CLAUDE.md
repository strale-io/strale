...
- Predecessors, still live and billable: kyc-sweden, kyc-norway, kyc-denmark, kyc-finland, verify-us-company. These were listed here as deprecated/`isActive: false`, but production has all five at `is_active = true, x402_enabled = true` (verified 2026-08-14). They predate the KYB Essentials/Complete families and overlap them. Treat the DB as authoritative; do not deactivate them on the strength of this file alone — they are reachable, x402-enabled, and rank highly in `/v1/suggest`.
