...
- **DEC-20260904-C** (global, active): **Capabilities labelled Unverified are listed on the website with the label, not hidden.** Directed by Petter 2026-09-04 on the M2 batch-9 finding that the website's `isSQSUnqualified` filter hid every capability labelled Unverified, the opposite of DEC-20260313-C, and since paid capabilities receive no proactive testing (DEC-20260503-B, DEC-20260812-A) it was hiding working paid capabilities. Affirms DEC-20260313-C; pending and Building-track-record states keep their behaviour. Implemented as a filter correction in `strale-frontend` (kept in maintenance under DEC-20260902-A). Notion Decisions DB entry filed 2026-09-04; repo-native record follows through the M2 closure path.
