...
Intended order: T1, T2, T3, T11, T4, T5, T10, T6, T7, T8, T9 (T11 was
inserted on 2026-09-02 when the founder approved the website sweep). Only `depends_on` in the
...
tracks allowed outside the gate (T1 to T5 and T11), and any track not on that list is
