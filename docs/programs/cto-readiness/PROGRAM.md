...
Intended order: T1, T2, T3, T11, T12, T4, T5, T10, T6, T7, T8, T9 (T11 and
T12 were inserted on 2026-09-02 when the founder approved the website sweep
and the authority plan). Only `depends_on` in the
...
tracks allowed outside the gate (T1 to T5, T11 and T12), and any track not on that list is
