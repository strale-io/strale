...
- **Measured 2026-09-11 — revenue fell for the first time in five completed
  ...
  *The week in progress (day 5 of 7, no verdict drawn):* €38.97 across 11
  payers, top share 94.5%. The largest buyer's daily rate is ~€8.7 against
  ~€7.8 last week — steady, which is what makes the concentration bar the only
  bar that matters.

  *Two facts worth carrying, both small.* One wallet other than the largest has
  ...
  *German, closed as a watch.* OpenRegister's allowance reset and the tower
  ...
  2026-09-06T23:46Z, verified on the rail. The largest buyer has **not** returned
  to German since (one unrelated paid lookup on 09-10, a correct not-found), so
  the trigger set on 08-27 — re-open only if the reset is exhausted again
  immediately — did not fire, and that verdict stands. 498 of 500 credits
  remain.
