...
const seedCapabilities = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        org_number: {
          type: "string",
          description: "Swedish org number (10 digits, e.g. 556703-7485)",
        },
        company_name: {
          type: "string",
          description: "Company name for fuzzy search",
        },
      },
      required: [],
    },
  ...
  // ─── New capabilities (DEC-20260226-P-s3t4) ─────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        company_name: { type: "string", description: "Company name for fuzzy search" },
      },
      required: [],
    },
    outputSchema: {
  ...
  // ─── EU Company Registries (15) ─────────────────────────────────────────────
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { company_number: { type: "string", description: "UK Companies House number (8 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
  ...
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { kvk_number: { type: "string", description: "Dutch KVK number (8 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
  ...
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { siren: { type: "string", description: "SIREN (9 digits) or SIRET (14 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
  ...
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { enterprise_number: { type: "string", description: "KBO/BCE enterprise number (e.g. 0404.616.494)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { fn_number: { type: "string", description: "Firmenbuchnummer (e.g. FN 150913f)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { cro_number: { type: "string", description: "CRO number (5-6 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { krs_number: { type: "string", description: "KRS number (10 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
  ...
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { registry_code: { type: "string", description: "Estonian registry code (8 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
  ...
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { reg_number: { type: "string", description: "Latvian registration number (11 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { company_code: { type: "string", description: "Lithuanian company code (7-9 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { uid: { type: "string", description: "Swiss UID (e.g. CHE-105.805.977)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { cif: { type: "string", description: "CIF/NIF number (e.g. A28015865)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { partita_iva: { type: "string", description: "Partita IVA (11 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  {
    ...
    category: "data-extraction",
    inputSchema: { type: "object", properties: { nipc: { type: "string", description: "NIPC number (9 digits)" }, company_name: { type: "string", description: "Company name for fuzzy search" } }, required: [] },
    outputSchema: { type: "object", properties: { company_name: { type: "string" }, registration_number: { type: "string" }, business_type: { type: "string" }, address: { type: "string" }, status: { type: "string" } } },
    priceCents: 80,
  },
  ...
  // ─── Regulatory & Trade (3) ─────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      required: ["name"],
      properties: {
        name: { type: "string", description: "Person or company name to check" },
  ...
  // ── Dark launch batch 1 — compliance, contact verification, financial utilities ──
  {
    ...
    inputSchema: {
      ...
      required: ["name"],
      properties: {
        name: { type: "string", description: "Full name of person to screen" },
  ...
  },
  {
    ...
    description: "Screen a person or company for adverse news coverage across 235,000+ global sources via Dilisense (primary) with Serper Google search fallback. Returns audit-grade evidence: risk level with documented thresholds, FATF-aligned category counts (financial crime, terrorism, organized crime, regulatory, political, violent crime), top article headlines with source URLs, and the rule used to classify severe vs non-severe coverage.",
    category: "compliance",
    inputSchema: {
      type: "object",
      required: ["name"],
      properties: {
        ...
        entity_name: { type: "string", description: "Alias for name (optional)" },
        country: { type: "string", description: "Additional context like industry or country (optional)" },
        entity_type: { type: "string", enum: ["person", "company"], description: "Override auto-detection (optional)" },
      },
    },
    outputSchema: {
      ...
      properties: {
        ...
        risk_level_thresholds: { type: "object" },
        total_hits: { type: "integer" },
        categories: { type: "object" },
        categories_found: { type: "array" },
        severe_categories: { type: "array" },
        top_articles: { type: "array" },
        lists_queried: { type: "object", properties: { collection: { type: "string" }, source_count: { type: ["integer", "null"] }, version: { type: ["string", "null"] }, last_updated_at: { type: ["string", "null"] } } },
        screened_at: { type: "string" },
        period: { type: "string" },
        source: { type: "string", enum: ["dilisense", "serper"] },
