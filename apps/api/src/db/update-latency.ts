...
const updates: [string, number][] = [
  ...
  // ─── Finance / fintech ──────────────────────────────────────────────────────
  ["bank-bic-lookup", 20],
  ["ecb-interest-rates", 2000],
  ["country-tax-rates", 20],
  ["invoice-validate", 20],
  ["payment-reference-generate", 10],
  ["swift-message-parse", 10],
  ["financial-year-dates", 10],
  ["sepa-xml-validate", 20],
  ["ticker-lookup", 1000],
  ["forex-history", 2000],
  // ─── Legal / compliance ─────────────────────────────────────────────────────
  ["eu-court-case-search", 8000],
  ["gdpr-fine-lookup", 8000],
  ["eu-ai-act-classify", 20],
  ["data-protection-authority-lookup", 10],
  ["cookie-scan", 8000],
  ["terms-of-service-extract", 8000],
  ["privacy-policy-analyze", 8000],
  ["business-license-check-se", 8000],
  // ─── Logistics / supply chain ───────────────────────────────────────────────
  ["customs-duty-lookup", 8000],
  ["incoterms-explain", 10],
  ["container-track", 8000],
  ["port-lookup", 10],
  ["country-trade-data", 2000],
  ["iso-country-lookup", 10],
  ["dangerous-goods-classify", 10],
  // ─── Recruiting / HR ────────────────────────────────────────────────────────
  ["salary-benchmark", 8000],
  ["job-board-search", 3000],
  ["skill-extract", 20],
  ["skill-gap-analyze", 10],
  ["linkedin-url-validate", 2000],
  ["work-permit-requirements", 10],
  ["employer-review-summary", 8000],
  ["public-holiday-lookup", 1000],
  ["employment-cost-estimate", 10],
  // ─── E-commerce / retail ────────────────────────────────────────────────────
  ["product-search", 8000],
  ["price-compare", 8000],
  ["product-reviews-extract", 8000],
  ["trustpilot-score", 8000],
  ["vat-rate-lookup", 10],
  ["shipping-cost-estimate", 20],
  ["marketplace-fee-calculate", 10],
  ["return-policy-extract", 8000],
  // ─── Marketing / SEO ────────────────────────────────────────────────────────
  ["keyword-suggest", 3000],
  ["serp-analyze", 2000],
  ["backlink-check", 5000],
  ["page-speed-test", 8000],
  ["social-profile-check", 5000],
  ["og-image-check", 2000],
  ["email-deliverability-check", 3000],
  ["website-carbon-estimate", 2000],
];
