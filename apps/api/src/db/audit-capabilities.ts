...
// see apps/api/src/capabilities/auto-register.ts. Mirroring the executor
// list manually here (the old pattern) drifted: caps were deleted upstream
// while the imports stayed, breaking the script at runtime.
