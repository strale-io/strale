...
// budget can't be scaled to the input the way prompt-optimize does — it's a
// fixed, generous ceiling instead. ~8000 tokens ≈ 32KB of markdown:
// comfortably larger than any real README, well inside Haiku 4.5's 64K output
// limit, and below the ~16K non-streaming HTTP-timeout threshold. The old
// 3000-token cap truncated every comprehensive README mid-JSON, which 500'd
// all production calls (3/3 failures, 2026-06-17→24).
